...
def init():
    ...
    global EVENT_FILE, FILTER_FILE, LOG_FILE, QUESTS_FILE, POKEMON_LIST_FILE, ERROR_LOG_FILE, PLAYINTEGRITY_UPDATER_FILE, MAD_LOG_FILE
    ...
    MAD_LOG_FILE = os.getenv('MAD_LOG_FILE')
