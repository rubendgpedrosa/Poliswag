...
def init():
    ...
    global CONVIVIO_CHANNEL_ID, EVENT_CHANNEL_ID, MAPSTATS_CHANNEL_ID, MOD_CHANNEL_ID, QUEST_CHANNEL_ID, VOICE_CHANNEL_ID, VOICE_CHANNEL_MARINHA_ID, POLISWAG_MESSAGE_ID
    ...
    POLISWAG_MESSAGE_ID = int(os.getenv('POLISWAG_MESSAGE_ID'))
